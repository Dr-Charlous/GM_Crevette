...
sp_hit = s_enemy_hit_cac;
sp_dead = s_enemy_dead_cac;
...
my_bow1 = instance_create_depth(x, y, 99, o_wpn_enemy_cac);
my_bow2 = instance_create_depth(x, y, 99, o_wpn_enemy_cac);